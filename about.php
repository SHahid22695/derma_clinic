  ...
  <div class="container">
    <div class="row justify-content-end">
      <div class="col-md-6">
        ...
        <p class="ftco-animate">At Sparlex, we believe in the power of relaxation and self-care. Our professional team is dedicated to providing you with the highest quality beauty and wellness services.</p>
      ...
      <div class="col-md-4 d-flex align-items-stretch">
        <div class="offer-deal text-center px-2 px-lg-5">
          ...
          <div class="text mt-4">
            ...
            <p class="mb-5">Check out our seasonal discounts and special offers.</p>
        ...
        <div class="carousel-testimony owl-carousel">
          ...
          <div class="item">
            <div class="testimony-wrap p-4 pb-5">
              <div class="text">
                <div class="line pl-5">
                  <p class="mb-4 pb-1">Professional staff and amazing atmosphere. Highly recommended!</p>
                  <span class="quote d-flex align-items-center justify-content-center"><i class="icon-quote-left"></i></span>
                </div>
                <div class="d-flex align-items-center">
